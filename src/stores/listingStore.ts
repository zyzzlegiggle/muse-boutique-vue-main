    ...
    products: [
      {
        ...
        description:
          'An oversized, double-breasted trench coat tailored from pure, heavy-weight European linen. Featuring a relaxed drape and storm flaps.',
        details:
          'Crafted with premium European linen, this trench coat is designed to soften with wear. The structure remains relaxed yet sophisticated, making it a perfect layering piece for transitional climates. Features deep welt pockets, adjustable sleeve straps, and a removable self-tie belt.',
        specs: [
          '100% European Linen',
          'Corozo nut buttons',
      ...
      },
      {
        ...
        description:
          'A fine-gauge ribbed knit top in a luxurious silk-cotton blend. Features a high halter neckline and clean-finished edges.',
        details:
          'Designed for a second-skin feel, this top combines the breathability of cotton with the soft sheen and elegant drape of mulberry silk. The halter neckline flatters the shoulders, making it a minimal yet expressive styling option.',
        specs: [
      ...
      },
      {
        ...
        description:
          'High-waisted tailored trousers drape gracefully in a mid-weight virgin wool crepe. Finished with double front pleats.',
        details:
          'These trousers offer a modern, relaxed silhouette with an elevated, high-rise waist and sharp front pleats. Designed to pool slightly over shoes, they combine masculine tailoring with soft feminine lines.',
        specs: [
      ...
      },
      {
        ...
        image: travertineImg,
        description:
          'A decorative stone bowl, hollowed and shaped from a single block of raw cream-colored Italian Travertine stone.',
        details:
          'The Travertine Vessel celebrates the raw beauty of natural stone. Each piece features unique geologic pores, cavities, and shade variations. Perfect as a standalone sculpture on a coffee table or a minimal home for treasured items.',
        specs: [
      ...
      },
      {
        ...
        image: decanterImg,
        description:
          'An organically shaped beverage decanter. Features a delicate, hand-pulled spout and a spherical wood cork.',
        details:
          'Mouth-blown by glass artisans, this decanter stands as a functional sculpture. The organic, slightly imperfect shape responds beautifully to light, making any liquid within look like art.',
        specs: [
      ...
      },
      {
        ...
        description:
          'A low-profile incense holder, hand-thrown in coarse stoneware and coated in a soft matte metallic black glaze.',
        details:
          'The Ceramic Incense Dish features a raw, textured exterior with a glazed interior reservoir to catch ash. Designed to accommodate both stick and cone incense, it rests low on any shelf, promoting calm and focus.',
        specs: [
      ...
      },
      {
        ...
        image: perfumeImg,
        description:
          'A clean, grounding perfume featuring rich base notes of Japanese Hinoki cypress, cedarwood, and green moss.',
        details:
          'Hinoki captures the scent of rain-soaked wooden temples in the forests of Japan. A dry, woody heart of cedar and cypress is balanced by initial bright citrus notes of yuzu, settling into a damp, grounding moss finish.',
        specs: [
      ...
      },
      {
        ...
        image: santoriniImg,
        description:
          'An atmospheric room and linen spray capturing the hot, sun-baked landscape of the Cyclades.',
        details:
          'A mist that transports you directly to summer afternoons in Greece. Combining the earthy sweetness of wild fig leaves, dry dusty clay paths, and a fresh, crisp mineral splash of Aegean Sea salt spray.',
        specs: [
      ...
      },
      {
        ...
        description:
          'A slow-burning container candle poured with natural soy wax and scented with vetiver root and warm amber.',
        details:
          'Pouring warmth and low, ambient light into a space, the Smoked Vetiver Candle opens with dry vetiver root and birch tar smoke, warming into a heart of patchouli, and leaving a lingering trail of sweet vanilla-amber.',
        specs: [
